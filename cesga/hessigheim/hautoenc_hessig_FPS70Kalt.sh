...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/hessigheim/hautoenc_hessig_train_X_FPS70Kalt.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/hessigheim/hautoenc_hessig_predict_X_FPS70Kalt.json'
