...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/vegetation/pnet_final_XIrRGB_training_T1_alt.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/vegetation/pnet_final_XIrRGB_predict_T1_alt.json'
