...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/pnetpp_galicia_try27_training_XIrRGB_T1.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/pnetpp_galicia_try27_predict_XIrRGB_T1.json'
