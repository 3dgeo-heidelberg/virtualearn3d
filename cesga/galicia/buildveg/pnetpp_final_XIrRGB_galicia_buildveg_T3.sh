...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/pnetpp_final_XIrRGB_buildveg_training_T3.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/pnetpp_final_XIrRGB_buildveg_predict_T3.json'
