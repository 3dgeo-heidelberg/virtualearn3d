...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/kpconv_final_X_buildveg_training_T5.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/kpconv_final_X_buildveg_predict_T5.json'
