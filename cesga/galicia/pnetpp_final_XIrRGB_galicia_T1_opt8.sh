...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/pnetpp_final_XIrRGB_training_T1_opt8.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/pnetpp_final_XIrRGB_predict_T1_opt8.json'
