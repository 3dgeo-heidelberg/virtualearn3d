...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/building/pnetpp_final_XIrRGB_building_training_T2.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/building/pnetpp_final_XIrRGB_building_predict_T2.json'
