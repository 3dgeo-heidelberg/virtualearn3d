...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/lmhveg/kpconv_final_X_lmhveg_training_T1.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/lmhveg/kpconv_final_X_lmhveg_predict_T1.json'
